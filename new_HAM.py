...
try:
    ...
    #### e.g.  python new_HAM.py /home/henson/KDD16_HAM-master/task/edges_football.txt /home/henson/KDD16_HAM-master/task/HAM_com_football.txt



# datapath = os.getcwd() + '/task/'
# adj_name = 'edges_football'  # Note: the data index starts from 0, not from 1
# community_name = 'HAM_com_football'
#
...
#topk = 6  # the number of selected SH spanner
...
print(SHrank[0:int(topk)])  # Note: the index starts from 0, not from 1
out_file=open("HAM_top.csv",'a+',encoding="utf-8")
writer=csv.writer(out_file)
writer.writerow(SHrank[0:int(topk)])
